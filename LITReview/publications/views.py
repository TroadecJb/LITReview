...
class TicketDeleteConfirmation(generic.DetailView):
    ...
    def get(self, request, ticket_id):
        ...
        if request.user == ticket.user:
            ...
            return render(
                request,
                "publications/delete_confirmation.html",
                context=context,
            )
...
class CreateReview(generic.DetailView):
    ...
    def get(self, request):
        ...
        return render(
            request, "publications/create_review.html", context=context
        )
...
class CreateReviewFromTicket(generic.DetailView):
    ...
    def get(self, request, ticket_id):
        ...
        return render(
            request, "publications/create_reply_review.html", context=context
        )
...
class CreateTicket(generic.DetailView):
    ...
    def get(self, request):
        ...
        return render(
            request, "publications/create_ticket.html", context=context
        )
...
class EditReview(generic.DetailView):
    ...
    def get(self, request, review_id):
        ...
        if request.user == review.user and request.user == ticket.user:
            ...
            return render(
                request,
                "publications/edit_ticket_review.html",
                context=context,
            )
            ...
            return render(
                request, "publications/edit_review.html", context=context
            )
    ...
    def post(self, request, review_id):
        ...
        if "edit_review" in request.POST:
            if request.user == review.user and request.user == ticket.user:
                ...
                edit_ticket_from = TicketForm(
                    request.POST, request.FILES, instance=ticket
                )

                if all(
                    [edit_review_form.is_valid(), edit_ticket_from.is_valid()]
                ):
...
class EditTicket(generic.DetailView):
    ...
    def get(self, request, ticket_id):
        ...
        if request.user == ticket.user:
            ...
            return render(
                request, "publications/edit_ticket.html", context=context
            )
        return redirect("publications:feed")
